    ...
    <div class="max-w-7xl mx-auto space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-stone-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-stone-100 flex items-center justify-between bg-stone-50/50">
                ...
                <span
                    class="bg-orange-100 text-orange-700 text-xs font-bold px-2.5 py-0.5 rounded-full"><?php echo e($users->count()); ?>
...
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['User Information', 'System Role', 'Status', 'Actions']),'search' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr
                        class="hover:bg-stone-50 transition-colors <?php echo e($user->Status === 'Inactive' ? 'bg-stone-50 opacity-75' : ''); ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-bold text-stone-900"><?php echo e($user->FullName); ?></div>
                                    <div class="text-xs text-stone-500 font-medium">@<span><?php echo e($user->Username); ?></span></div>
                                </div>
                            </div>
                        </td>
                        ...
                        <!-- Role -->
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-semibold text-stone-700"><?php echo e($user->Role); ?></div>
