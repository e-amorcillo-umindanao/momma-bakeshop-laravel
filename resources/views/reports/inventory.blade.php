...
@section('content')
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
            ...
            <form method="GET" action="{{ route('reports.inventory') }}" class="flex items-end gap-3 bg-white p-3 rounded-xl shadow-sm border border-slate-200">
                <div>
                        ...
                        @forelse($movements as $movement)
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-900">
                                    ...
                                    <span class="text-slate-400 font-normal ml-1">{{ \Carbon\Carbon::parse($movement->DateAdded)->format('h:i A') }}</span>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-600 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <img class="h-6 w-6 rounded-full border border-slate-200 shadow-sm" src="https://ui-avatars.com/api/?name={{ urlencode($movement->user->FullName ?? 'System') }}&background=f1f5f9&color=475569" alt="User Avatar">
