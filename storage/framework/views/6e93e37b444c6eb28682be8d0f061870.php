...
<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
            ...
            <form method="GET" action="<?php echo e(route('reports.inventory')); ?>" class="flex items-end gap-3 bg-white p-3 rounded-xl shadow-sm border border-stone-200">
                <div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $movements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-stone-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-stone-900">
                                    ...
                                    <span class="text-stone-400 font-normal ml-1"><?php echo e(\Carbon\Carbon::parse($movement->DateAdded)->format('h:i A')); ?></span>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-stone-600 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <img class="h-6 w-6 rounded-full border border-stone-200 shadow-sm" src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($movement->user->FullName ?? 'System')); ?>&background=f1f5f9&color=475569" alt="User Avatar">
