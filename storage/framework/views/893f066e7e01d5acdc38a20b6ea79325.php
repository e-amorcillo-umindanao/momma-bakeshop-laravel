                    ...
                    <div class="relative" x-data="{ notifOpen: false }" @click.away="notifOpen = false">
                        ...
                        <div x-show="notifOpen" 
                            ...
                            <div class="max-h-80 overflow-y-auto">
                                <?php if($lowStockProducts->count() > 0): ?>
                                    <div class="divide-y divide-slate-100">
                                        ...
                                        <a href="<?php echo e(route('inventory.index')); ?>" class="block px-4 py-3 hover:bg-slate-50 transition-colors group">
                                            <div class="flex items-start gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-xs text-slate-500 mt-0.5"><span class="font-semibold text-slate-700"><?php echo e($product->ProductName); ?></span> is running low (<?php echo e($product->Quantity); ?> remaining).</p>
                                                    <p class="text-[10px] text-slate-400 mt-1 uppercase tracking-wider"><?php echo e(\Carbon\Carbon::now()->diffForHumans()); ?></p>
                                                </div>
                                            </div>
                                        </a>
                            ...
                            <div class="px-4 py-2 bg-slate-50 border-t border-slate-100">
                                <a href="<?php echo e(route('inventory.index')); ?>" class="block text-center text-xs font-semibold text-indigo-600 hover:text-indigo-700 transition-colors">View Inventory</a>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
