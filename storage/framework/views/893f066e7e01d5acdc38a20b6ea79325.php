                ...
                <div class="flex items-center gap-5">
                    ...
                    <div class="relative" x-data="{ profileOpen: false }" @click.away="profileOpen = false">
                        <button @click="profileOpen = !profileOpen" class="flex items-center gap-3 focus:outline-none">
                            <img class="h-8 w-8 rounded-full object-cover border border-stone-200 shadow-sm" src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->check() ? auth()->user()->FullName : 'Admin User')); ?>&background=4f46e5&color=fff" alt="User Avatar">
