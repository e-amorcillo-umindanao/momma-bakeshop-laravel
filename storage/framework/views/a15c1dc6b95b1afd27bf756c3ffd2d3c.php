...
<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div
                class="bg-gradient-to-br from-white to-rose-50/30 rounded-2xl p-6 shadow-sm border <?php echo e($lowStockProducts > 0 ? 'border-rose-200' : 'border-stone-200'); ?> relative overflow-hidden flex flex-col justify-between">
                <div class="absolute top-0 right-0 p-4 opacity-10">
                    <svg class="w-32 h-32 <?php echo e($lowStockProducts > 0 ? 'text-rose-600' : 'text-stone-400'); ?>" fill="none"
                ...
                <div class="relative z-10">
                    <div class="flex items-center gap-3 mb-2">
                        <div
                            class="p-2 <?php echo e($lowStockProducts > 0 ? 'bg-rose-100 text-rose-600' : 'bg-stone-100 text-stone-500'); ?> rounded-lg">
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex items-baseline gap-2">
                        <span
                            class="text-4xl font-black tracking-tighter <?php echo e($lowStockProducts > 0 ? 'text-rose-600' : 'text-stone-700'); ?>"><?php echo e($lowStockProducts); ?></span>
                ...
                <div class="relative z-10 mt-8">
                    <a href="<?php echo e(route('reports.inventory')); ?>"
                        class="inline-flex w-full justify-center items-center px-4 py-2.5 text-sm font-semibold <?php echo e($lowStockProducts > 0 ? 'text-rose-700 bg-rose-100 border-rose-200 hover:bg-rose-200' : 'text-stone-700 bg-white border-stone-300 hover:bg-stone-50'); ?> border rounded-xl shadow-sm transition-all">
