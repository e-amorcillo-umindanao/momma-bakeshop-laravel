                                ...
                                <li
                                    ...
                                    <div class="flex-shrink-0 mr-4">
                                        <div class="w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold
                                                        ...
                                                        <?php elseif($index == 1): ?> bg-stone-200 text-stone-600 border border-stone-300
                                                        <?php elseif($index == 2): ?> bg-amber-50 text-amber-800 border border-amber-100
                                                        <?php else: ?> bg-stone-100 text-stone-500 border border-stone-200
                                                        <?php endif; ?>">
                                            #<?php echo e($index + 1); ?>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="text-sm font-bold text-stone-800 truncate"><?php echo e($item->ProductName); ?></p>
                                        <p class="text-xs text-stone-500 font-medium mt-0.5 uppercase tracking-wider">Unit Sales</p>
                                    </div>
                                    <div class="text-right">
                                        <div class="text-lg font-black text-orange-600"><?php echo e($item->total_sold); ?></div>
                                    </div>
                                </li>
