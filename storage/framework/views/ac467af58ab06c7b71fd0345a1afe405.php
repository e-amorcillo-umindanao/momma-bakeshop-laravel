    ...
    <div class="p-6 max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-3 mb-2">
                ...
                <h2 class="text-2xl font-bold text-stone-800">Record Stock-Out (To Kitchen)</h2>
            </div>
            <p class="text-stone-500 text-sm ml-11">Issue raw materials from your inventory to the kitchen.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-stone-100 p-6 md:p-8">
            <form action="<?php echo e(route('inventory.store_stock_out')); ?>" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Quantity -->
                    <div class="space-y-2 md:col-span-2">
                        <label class="block text-sm font-semibold text-stone-700">Quantity Issued to Kitchen <span
                                class="text-red-500">*</span></label>
                        <div class="relative">
                            <span
                            ...
                            <input type="number" name="Quantity" min="1" required
                                class="w-full pl-10 pr-4 py-3 bg-stone-50 border border-stone-200 rounded-xl text-stone-800 focus:outline-none focus:ring-2 focus:ring-stone-500/20 focus:border-stone-500 transition-all placeholder-stone-400"
                ...
                <div class="pt-6 mt-6 border-t border-stone-100 flex items-center justify-end gap-3">
                    ...
                    <button type="submit"
                        class="px-5 py-2.5 text-sm font-medium text-white bg-stone-800 rounded-xl hover:bg-stone-900 transition-colors shadow-sm shadow-stone-800/20 focus:outline-none focus:ring-2 focus:ring-stone-500 focus:ring-offset-2 flex items-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
