...
<?php $__env->startSection('content'); ?>
    <div class="h-[calc(100vh-8rem)] flex flex-col md:flex-row gap-6" x-data="posSystem(<?php echo e($products->toJson()); ?>)">
                        ...
                        <template x-for="product in filteredProducts" :key="product.ID">
                            <button @click="addToCart(product)"
                                ...
                                <div
                                    ...
                                    <img :src="'/images/products/' + product.ProductName.toLowerCase().replace(/[^\w\s-]/g, '').replace(/[\s_-]+/g, '-').replace(/^-+|-+$/g, '') + '.jpg'"
        ...
        <div
            ...
            <div class="bg-white border-t border-slate-200 p-5 shrink-0 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                ...
                <form action="<?php echo e(route('pos.checkout')); ?>" method="POST" id="checkoutForm"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Evan\OneDrive\Desktop\IT12 Project\MommasBakeshop\resources\views/pos/index.blade.php ENDPATH**/ ?>